...
import FrmListadoProducto, { FrmListadoProducto_Url } from "../components/product/FrmListadoProducto";
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route path={FrmListadoProducto_Url} component={FrmListadoProducto} exact={true} />
